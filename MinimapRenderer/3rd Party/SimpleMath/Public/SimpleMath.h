...
namespace DirectX
{
	namespace SimpleMath
	{
		...
		//------------------------------------------------------------------------------
		// 4x4 Matrix - Modified perspective and look at functions to use LH coordinates, however Up/Right/Back/Left as well as other functions may be wrong
		struct Matrix : public XMFLOAT4X4
		{
			...
			static Matrix CreateInversePerspectiveFieldOfView(float fov, float aspectRatio, float nearPlane, float farPlane);
			...
			static Matrix SRT(const Vector3& scale, const Quaternion& rotation, const Vector3& translation);
			static void SRT(const Vector3& scale, const Quaternion& rotation, const Vector3& translation, Matrix& result);
